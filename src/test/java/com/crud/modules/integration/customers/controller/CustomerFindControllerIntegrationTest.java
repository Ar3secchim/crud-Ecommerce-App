...
public class CustomerFindControllerIntegrationTest {
  ...
  @Test
  void customerGetByIdWithSuccess() throws Exception {
  ...
  @Test
  void customerGetByIdWithException() throws Exception {
    when(findCustomer.findById(customer.getIdTransaction()))
            .thenThrow(new BadRequestClient("Customer not found with ID: " + customer.getIdTransaction()));
  ...
  @Test
  void customerGetByEmailWithSuccess() throws Exception {
    CustomerResponse customerResponse = CustomerConvert.toResponse(customer);
  ...
  @Test
  void customerGetByEmailException() throws Exception {
    when(findCustomer.findByEmail(customer.getEmail()))
            .thenThrow(new BadRequestClient("Customer not found with email: " + customer.getEmail()));
  ...
  @Test
  void customerGetByNameWithSuccess() throws Exception {
  ...
  @Test
  void customerGetByListName() throws Exception {
    when(findCustomer.findByName("int-test"))
